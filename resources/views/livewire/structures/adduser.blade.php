          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-primary d-flex align-items-center">
                <h2 class="card-title flex-grow-1"><i class="fa fa-user-circle fa-2x"></i> {{ optional($selectedStruct)->libelle }} </h2>
                   ...
                   @foreach($Users as $user)
                    <tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-link"wire:click="addUser({{$user->id}})" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ajouter un utilisateur" > <i class="fa fa-plus-square"></i> </button>
